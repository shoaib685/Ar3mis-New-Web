...
<body id="top">
  ...
  <main>
    <article>
      ...
      -->
      <?php
    if($_GET['err'] =='emailorpass_incorrect'){
        echo '';
    }
?>
<script>alert('worng pass')</script>
      <section class="hero" id="hero">
        <div class="container">

        <form action="login_handle.php" method="post">
            <div class="form-control">
                <input type="text" class="login-inp input" name="email" id="email" placeholder="email">
                <input type="password" class="login-inp input" name="pass" id="pass" placeholder="password">
