    ...
    <article>
      ...
      <?php
        if($_POST){
            ...
            <form action="handle_verify.php" method="post">
                <div class="form-control">
                    <input type="email" class="login-inp input" name="email" id="email" placeholder="email">
                    <input type="password" class="login-inp input" name="otp" id="otp" placeholder="OTP">
                    <button type="submit">Verify</button>
                </div>
                <p>Don\'t recieve an otp? <a href="resend.php">Sign-up</a></p>
            </form>
